...
public class GameOver extends JFrame {
    ...
    // Der Konstruktor der Klasse "GameOver". Er initialisiert das Layout und die Komponenten des Fensters.
    public GameOver(int level) {
        super("Game Over");
        // Spielt einen Soundeffekt ab, wenn das Spiel verloren ist.
